screen roomdownscreen:
    imagemap:
        ...
        hotspot(814, 873, 192, 179) action Jump ("plant")
        hotspot(909, 469, 94, 114) action Jump ("trash")
        hotspot(632, 699, 106, 82) action Jump ("phone")
        hotspot(1133, 619, 182, 203) action Jump ("tv")
        hotspot(1055, 672, 66, 271) action Jump("cds")
        hotspot(1033, 269, 144, 128) action Jump("computer")
screen roomupscreen:
    imagemap:
